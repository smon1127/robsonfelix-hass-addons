(function () {
  ...
  // Buttons — esc first, arrows, sel, paste (left), then modifiers, keyboard, resize (right)
  ...
  // -- Terminal area touch scroll (single-finger, natural direction, with inertia) --
  var termScroll = {
    active: false,
    lastY: 0,
    remainder: 0,
  ...
  function onTermTouchMove(e) {
    ...
    var dy = termScroll.lastY - curY; // natural: swipe up = scroll down into history
    var now = Date.now();
